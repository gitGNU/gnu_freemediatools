...
namespace olib {
  namespace openmedialib {
    ...
    bool template_store::push( frame_type_ptr frame )
    {
    ...
    frame_type_ptr template_store::flush( )
    { 
      return frame_type_ptr( ); 
    }

    void template_store::complete( )
    { }
...
extern "C"
{
  ...
  {
    //    boost::recursive_mutex::scoped_lock lock( anon2::mutex12 );
    anon2::reflib( 1 );
    return true;
  }
