...
image_type_ptr rgb_to_rgb( const image_type_ptr &src_img, const opl::wstring &format )
{
	size_type width = src_img->width( );
	size_type height = src_img->height( );
...
static image_type_ptr rgbe_to_r32g32b32a32f( image_type_ptr src_img, const opl::wstring &format )
{
	size_type width  = src_img->width( );
	size_type height = src_img->height( );
...
static image_type_ptr r32g32b32f_to_rgbe( image_type_ptr src_img, const opl::wstring &format )
{
	size_type width  = src_img->width( );
	size_type height = src_img->height( );
...
static image_type_ptr r32g32b32f_to_r32g32b32a32f( image_type_ptr src_img, const opl::wstring &format )
{
	size_type width  = src_img->width( );
	size_type height = src_img->height( );
...
static image_type_ptr b8g8r8a8_to_r32g32b32a32f( image_type_ptr src_img, const opl::wstring &format )
{
	size_type width  = src_img->width( );
	size_type height = src_img->height( );
...
namespace {
	...
	static openimagelib_plugin_ptr get_plug( const opl::wstring &resource, 
						 const opl::wstring type )
	{
	    
	  fprintf( stderr, "openimagelib il get_plug: res: %s type: %s\n", 
...
image_type_ptr load_image( const opl::wstring &resource )
{
	...
	return plug->load( opl::to_string( resource ).c_str() );
}
...
bool store_image( const opl::wstring &resource, image_type_ptr image )
{
	...
	return plug->store( opl::to_string( resource ).c_str(), image );	
}
...
/mnt/sda10/mdupont/experiments/video/js/openlibraries/trunk/src/openimagelib/il/utility.cpp:3021: undefined reference to `olib::openpluginlib::discovery<olib::openimagelib::il::(anonymous namespace)::il_query_traits>::discovery(olib::openimagelib::il::(anonymous namespace)::il_query_traits const&)'
/mnt/sda10/mdupont/experiments/video/js/openlibraries/trunk/src/openimagelib/il/utility.cpp:3022: undefined reference to `olib::openpluginlib::discovery<olib::openimagelib::il::(anonymous namespace)::il_query_traits>::size() const'
/mnt/sda10/mdupont/experiments/video/js/openlibraries/trunk/src/openimagelib/il/utility.cpp:3023: undefined reference to `olib::openpluginlib::discovery<olib::openimagelib::il::(anonymous namespace)::il_query_traits>::begin() const'
