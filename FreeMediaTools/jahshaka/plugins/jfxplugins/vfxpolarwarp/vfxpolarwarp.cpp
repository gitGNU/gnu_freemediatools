...
void    MyPlugin::initializePlugin(void)
{
    ...
    pluginName    = "PolarWarpFx";          //name of plugin
    pluginClass   = JAH_CPU_PLUGIN;         //class of plugin ie CPU, GPU, MeshFX

    QString guid = "08679270-e0b8-11d9-947b-00e08161165f";
    setGuid(guid);
...
QRgb MyPlugin::getPolarWarp(int x, int y, int N)
{
//debug("get average");
