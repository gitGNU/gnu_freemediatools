...
MOVR  R2.z, {1}.x;
TEX   R1, R1, TEX0, 2D;
ADDR  R2.w, -weight.x, R2.z;
MADR  H0(GT.x), R1, R2.w, H1;
MOVR  R1.x, {4};
...
TEX   R1, R1, TEX0, 2D;
MADR  H0(GT.x), R1, R2.w, H1;
ADDR  R1.x, -transparency, R2.z;
MULR  R1, H0, R1.x;
MADR  o[COLH], R0, transparency.x, R1;
END
# 70 instructions, 4 R-regs, 3 H-regs
