...
void    MyPlugin::initializePlugin(void)
{
    ...
    QString guid = "d89ed052-e0b8-11d9-947b-00e08161165f";
    setGuid(guid);
    ...
    sliderlabel[0]="Sharpness";
    sliderlabel[1]="Weight";
...
void    MyPlugin::processGpuFx(void)
{
    ...
    stretch = 0.001;
    blend = 1.0;
    transparency = (slider[1] / 2000.0) + 0.05;
    quality = 0.0;
    weight = (slider[2] / 10000.0) - 0.24;
    ...
    {
        fragment_program = loadshaderfile(JahBasePath+"rfxnvsharpen/edgedetect_frag_gpu.fp");
    ...
    if (glGetError() == GL_INVALID_OPERATION)
    {
        find_shader_program_error(fragment_program, "edgedetect_frag_gpu.fp");
    }
