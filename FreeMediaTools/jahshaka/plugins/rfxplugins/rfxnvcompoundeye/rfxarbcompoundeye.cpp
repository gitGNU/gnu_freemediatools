...
{
    QString sourceName = tempBasePath+"plugins/rfxplugins/rfxnvcompoundeye/fisheye_frag_arb_gpu.fp";
...
void    MyPlugin::processGpuArbFx(void)
{
    ...
    {
        fragment_program = loadshaderfile(JahBasePath+"rfxnvcompoundeye/fisheye_frag_arb_gpu.fp");
