...
{
	QString sourceName = tempBasePath+"plugins/rfxplugins/rfxnvedgedetect/edgedetect_frag_arb_gpu.fp";
...
void    MyPlugin::processGpuArbFx(void)
{
    ...
    qualityshader="edgedetect_frag_arb_gpu.fp"; 
...
//     fxtimer->endtime();
//     fxtimer->printtime("Time for ARB Edgedetect: ");
}
