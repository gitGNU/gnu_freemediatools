...
void    MyPlugin::initializePlugin(void)
{
    ...
    QString guid = "5d195b8d-e0b8-11d9-947b-00e08161165f";
    setGuid(guid);
    ...
    sliderlabel[0]= "Horizontal Blur";
    sliderlabel[1]= "Vertical Blur";
    sliderlabel[2]= "Channel Effect";
...
void    MyPlugin::processGpuFx(void)
{
    ...
    qualityshader="channelblur_frag.fp"; 

    fragment_program = loadshaderfile(JahBasePath+"rfxnvchannelblur/"+qualityshader);
