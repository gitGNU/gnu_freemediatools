...
{
	QString sourceName = tempBasePath+"plugins/rfxplugins/rfxnvchannelblur/channelblur_frag_arb.fp";
...
void    MyPlugin::processGpuArbFx(void)
{
    ...
    qualityshader="channelblur_frag_arb.fp"; 
...
//     fxtimer->endtime();
//     fxtimer->printtime("Time for ARB Channelblur: ");
}
