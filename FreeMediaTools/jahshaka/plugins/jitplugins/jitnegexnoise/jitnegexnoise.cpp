...
void    MyPlugin::initializePlugin(void)
{
    ...
    pluginName    = "NegExpNoise";        //name of plugin
    pluginClass   = JAH_CPU_PLUGIN;                  //class of plugin ie CPU, GPU, MeshFX

    QString guid = "3307fd8b-e0b8-11d9-947b-00e08161165f";
    setGuid(guid);
...
QRgb MyPlugin::getNegGaussNoise(float VAR)
{
    //debug("get average");
    QRgb color;
    float NOISE;
