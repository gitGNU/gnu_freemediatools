/****************************************************************************
** FileMainFrame meta object code from reading C++ file 'jahfileframe.h'
**
** Created: Sat Jan 26 08:34:16 2008
...
const char *FileMainFrame::className() const
{
    return "FileMainFrame";
}

QMetaObject *FileMainFrame::metaObj = 0;
static QMetaObjectCleanUp cleanUp_FileMainFrame( "FileMainFrame", &FileMainFrame::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString FileMainFrame::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FileMainFrame", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString FileMainFrame::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FileMainFrame", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* FileMainFrame::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_FileMainFrame.setMetaObject( metaObj );
    return metaObj;
}

void* FileMainFrame::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "FileMainFrame" ) )
	return this;
    return QWidget::qt_cast( clname );
}

// SIGNAL loadButton
void FileMainFrame::loadButton()
{
    activate_signal( staticMetaObject()->signalOffset() + 0 );
}

bool FileMainFrame::qt_invoke( int _id, QUObject* _o )
{
...
bool FileMainFrame::qt_emit( int _id, QUObject* _o )
{
...
bool FileMainFrame::qt_property( int id, int f, QVariant* v)
{
    return QWidget::qt_property( id, f, v);
}

bool FileMainFrame::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
