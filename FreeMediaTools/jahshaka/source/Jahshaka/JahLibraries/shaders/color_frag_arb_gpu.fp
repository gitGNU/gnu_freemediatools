...
ABS R2.y, R2;
ABS R2.x, R2;
CMP R0.xyz, -R3.y, R0, R1.z;
MUL R2.w, R1.z, R2;
CMP R2.z, -R2.y, c[4], c[4].w;
CMP R2.x, -R2, c[4].z, c[4].w;
MUL R2.x, R2.z, R2;
CMP R1.x, -R2, c[4].z, R1;
MUL R1.x, R1, c[5].z;
FLR R2.x, R1;
ABS R2.y, R2.x;
CMP R3.x, -R2.y, c[4].z, c[4].w;
ADD R2.y, R1.x, -R2.x;
MUL R1.x, R2.z, R3;
CMP R3.w, -R1.x, R2, R0.z;
ADD R0.z, R2.x, -c[4].w;
ADD R3.y, -R2, c[4].w;
MAD R3.y, -R1, R3, c[4].w;
MUL R3.y, R1.z, R3;
MAD R1.y, -R1, R2, c[4].w;
ABS R3.z, R0;
ABS R3.x, R3;
CMP R0.z, -R3.x, c[4], c[4].w;
MUL R0.z, R2, R0;
CMP R3.x, -R3.z, c[4].z, c[4].w;
MUL R3.z, R0, R3.x;
ADD R2.z, R2.x, -c[5].y;
CMP R0.y, -R1.x, R3, R0;
CMP R0.x, -R1, R1.z, R0;
...
MUL R3.x, R0.z, R2.z;
CMP R3.w, -R3.z, R2, R3;
CMP R4.x, -R3, R3.y, R3.w;
ADD R3.w, R2.x, -c[5];
ABS R2.z, R2;
ABS R3.w, R3;
CMP R2.z, -R2, c[4], c[4].w;
CMP R0.y, -R3.z, R1.z, R0;
CMP R0.x, -R3.z, R1.y, R0;
MUL R2.z, R0, R2;
CMP R3.w, -R3, c[4].z, c[4];
MUL R0.z, R2, R3.w;
CMP R4.y, -R0.z, R1.z, R4.x;
ADD R4.x, R2, -c[5];
CMP R0.x, -R3, R2.w, R0;
ABS R3.w, R3;
CMP R3.w, -R3, c[4].z, c[4];
ABS R4.x, R4;
CMP R4.x, -R4, c[4].z, c[4].w;
MUL R2.z, R2, R3.w;
MUL R3.w, R2.z, R4.x;
...
CMP R2.x, -R2, c[4].z, c[4].w;
MUL R2.x, R2.y, R2;
CMP R0.y, -R3.w, R2.w, R0;
CMP R2.y, -R2.x, R2.w, R0;
CMP R4.y, -R3.w, R1.z, R4;
CMP R2.z, -R2.x, R1.y, R4.y;
CMP R0.x, -R3.w, R3.y, R0;
CMP R2.x, -R2, R1.z, R0;
MOV R2.w, R1;
ADD R0, R2, R0.w;
MIN R0.z, R0, c[4].x;
