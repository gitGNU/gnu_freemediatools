/****************************************************************************
** $Id: brushmetal.cpp,v 1.3 2005/07/20 08:03:18 jahshaka Exp $
**
...
void MetalStyle::polish( QApplication *app)
{
    ...
    QColor silver("#545454545454"); //same as topgrad below
    
    QPixmap button( 1, 1 ); button.fill( silver );
    //QPixmap button( metal_xpm ); 

    QPixmap background(metal_xpm);
    QPixmap dark( 1, 1 ); dark.fill( black.dark() );
    QPixmap mid( metal_xpm );
    QPixmap light( metal_xpm );//1, 1 ); light.fill( green );
...
{
    QColor top1("#848484848484");
    QColor top2("#C4C4C4C4C4C4");

    QColor bot2("#6D6D6D6D6D6D");
    QColor bot1("#545454545454"); //first from the bottom
...
{
    QColor highlight("#E5E5E5E5E5E5");
    QColor subh1("#CCCCCCCCCCCC");
    QColor subh2("#BCBCBCBCBCBC");

    QColor topgrad("#545454545454");
    QColor botgrad("#B7B7B7B7B7B7");
