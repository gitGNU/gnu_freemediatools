/****************************************************************************
** $Id: marble.cpp,v 1.1 2005/06/15 11:24:22 jahshaka Exp $
**
...
JahMetalStyle::JahMetalStyle() : QWindowsStyle() { }

/*!
  Reimplementation from QStyle
 */
void JahMetalStyle::polish( QApplication *app)
{
...
/*!
  Reimplementation from QStyle
 */
void JahMetalStyle::unPolish( QApplication *app)
{
...
/*!
  Reimplementation from QStyle
 */
void JahMetalStyle::polish( QWidget* w)
{
...
void JahMetalStyle::unPolish( QWidget* w)
{
...
void JahMetalStyle::drawPrimitive( PrimitiveElement pe,
                QPainter *p,
                const QRect &r,
...
void JahMetalStyle::drawControl( ControlElement element,
                  QPainter *p,
...
void JahMetalStyle::drawComplexControl( ComplexControl cc,
                     QPainter *p,
                     const QWidget *widget,
                     const QRect &r,
                     const QColorGroup &cg,
...
void JahMetalStyle::drawMetalButton( QPainter *p, int x, int y, int w, int h,
...
void JahMetalStyle::drawMetalFrame( QPainter *p, int x, int y, int w, int h ) const
{
...
void JahMetalStyle::drawMetalGradient( QPainter *p, int x, int y, int w, int h,
                    bool sunken, bool horz, bool flat  ) const
...
int JahMetalStyle::pixelMetric( PixelMetric metric, const QWidget *w ) const
{
    switch ( metric ) {
