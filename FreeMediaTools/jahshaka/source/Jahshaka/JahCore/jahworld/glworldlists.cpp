...
int
LayerListEntry::layer()   const 
{

 return thelayernumber;  }

JahLayer*       LayerListEntry::getJahLayer() 
{ return thelayer; }

EffectLayer*
LayerListEntry::addEffectLayer(
			       EffectInfo::EFFECT_TYPE effect_type,
			       bool status,
			       int pluginid );
