...
{ 
  if (getLayerList()->at(layer_number))
    {
...
{
  return sm_sTrackerFragmentShader;
}

QString    GLWorld::getModuleName()
{
  return m_qsModuleName;// was public
}
...
GLWorld::addSelectionFx(bool, QString, bool, bool)
GLWorld::changeSelection(int)
GLWorld::clearSelection(QListView*)
GLWorld::deleteEffectsList(JahLayer*)
GLWorld::deleteLightsList(JahLayer*)
GLWorld::delLayer()
GLWorld::effectNodeClicked(int)
GLWorld::findLayer(JahLayer*)
GLWorld::getImageLayer()
GLWorld::getModuleName()
GLWorld::getRenderAtImageResolution()
GLWorld::getSelectionTree(QListView*, int&, int&, bool&)
GLWorld::getUseLightingCheckBox()
GLWorld::initializeListview(int, bool)
GLWorld::initializeListview(JahLayer*, bool)
GLWorld::layerClicked(QListViewItem*)
GLWorld::loadObjObject()
GLWorld::moveLayerDown()
GLWorld::moveLayerUp()
GLWorld::multipleLayersSelectedInListView()
GLWorld::setImageLayer(JahLayer*)
GLWorld::setLayerVisible(int, bool)
GLWorld::setObjectTab(JahLayer*)
GLWorld::setSlidersHaveChanged(bool)
*/

void GLWorld::setSlidersHaveChanged(bool flag)
{
  m_bSlidersHaveChanged = flag;
}

bool GLWorld::getRenderAtImageResolution()
{
  return m_bRenderAtImageResolution;
}

QCheckBox* GLWorld::getUseLightingCheckBox()
{
  return m_pUseLightingCheckBox;
}

void GLWorld::setImageLayer(JahLayer* layer)
{
  m_pImageLayer = layer;
}


JahLayer*       GLWorld::getImageLayer()
{
...
/*
  new function,
  extracted from old source code off the net.
*/
