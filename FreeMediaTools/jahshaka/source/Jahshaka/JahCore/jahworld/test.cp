...
{
    //JahModuleLabel[0]->setText( tr( m_aJahModuleLabelTexts[0]  ) );
    //JahModuleLabel[1]->setText( tr( m_aJahModuleLabelTexts[1]  ) );
    //JahModuleLabel[2]->setText( tr( m_aJahModuleLabelTexts[2]  ) );
...
GLWorld::showSlider(int slider_number, bool flag)
{
    if (flag)
    {
        m_aJahSliders[slider_number]->show();
		#ifndef NEW_SLIDERS
        m_aJahSliderLCDs[slider_number]->show();
		#endif
		m_aJahSliderLabels[slider_number]->show();
    }
    else
    {
        m_aJahSliders[slider_number]->hide();
		#ifndef NEW_SLIDERS
        m_aJahSliderLCDs[slider_number]->hide();
		#endif
...
void GLWorld::setSliderValue(int slider, int value)
{
    if (m_bHasSliders)
    {
        int min_value = m_aJahSliders[slider]->minValue();
        int max_value = m_aJahSliders[slider]->maxValue();
        ...
        if (value < min_value)
        {
            m_aJahSliders[slider]->setMinValue(value);
        ...
        {
            m_aJahSliders[slider]->setMaxValue(value);
        ...
        {
            m_aJahSliders[slider]->setMinValue(-500);
            m_aJahSliders[slider]->setMaxValue(500);
        ...
        {
            m_aJahSliders[slider]->setMinValue(0);
        }

        m_aJahSliders[slider]->setValue(value);

		#ifndef NEW_SLIDERS
        m_aJahSliderLCDs[slider]->setValue(value);
		#endif
	}
}
...
void GLWorld::setDefaultSliderText(void)
{
    ...
    m_aJahSliderLabels[0]->setText( tr( m_aJahSliderLabelTexts[0]  ) );
    m_aJahSliderLabels[1]->setText( tr( m_aJahSliderLabelTexts[1]  ) );
    m_aJahSliderLabels[2]->setText( tr( m_aJahSliderLabelTexts[2]  ) );
    m_aJahSliderLabels[3]->setText( tr( m_aJahSliderLabelTexts[3]  ) );
    m_aJahSliderLabels[4]->setText( tr( m_aJahSliderLabelTexts[4]  ) );
    m_aJahSliderLabels[5]->setText( tr( m_aJahSliderLabelTexts[5]  ) );
    m_aJahSliderLabels[6]->setText( tr( m_aJahSliderLabelTexts[6]  ) );
    m_aJahSliderLabels[7]->setText( tr( m_aJahSliderLabelTexts[7]  ) );
    m_aJahSliderLabels[8]->setText( tr( m_aJahSliderLabelTexts[8]  ) );
...
{
    m_aJahModuleOptions[option]->setChecked(value);
...
{
    //m_pJTrace->debug( "GLWorld","updating slider display");
...
{
    //m_pJTrace->debug( "GLWorld","updating slider values");
    ...
    if ( !multipleLayersSelectedInListView() )
    {
        ...
        {
            motionNode* interpolated_values = m_pCamera->layernodes->m_node;
            //its the m_pCamera
        ...
        if ( getActiveJahLayer()->obm_pJtype == ObjectCategory::EFFECT )
        {
