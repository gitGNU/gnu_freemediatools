...
int 
MpegEncoder::quant_intra(short* src, short* dst, int dc_prec, unsigned char* quant_mat, int mquant)
{
	int i;
	int x, y, d;
...
int 
MpegEncoder::quant_non_intra(short* src, short* dst, unsigned char* quant_mat, int mquant)
{
	int i;
	int x, y, d;
	int nzflag;
...
void 
MpegEncoder::iquant_intra(short* src, short* dst, int dc_prec, unsigned char* quant_mat, int mquant)
{
	int i, val, sum;
...
void 
MpegEncoder::iquant_non_intra(short* src, short* dst, unsigned char* quant_mat, int mquant)
{
	int i, val, sum;
...
void 
MpegEncoder::iquant1_non_intra(short* src, short* dst, unsigned char* quant_mat, int mquant)
{
	int i, val;
