...
void Fill_Buffer()
{
  ...
  if (Buffer_Level < 2048)
  {
    ...
    {
      ld->Rdbfr[Buffer_Level++] = DECODER_SEQUENCE_END_CODE>>24;
      ld->Rdbfr[Buffer_Level++] = DECODER_SEQUENCE_END_CODE>>16;
      ld->Rdbfr[Buffer_Level++] = DECODER_SEQUENCE_END_CODE>>8;
      ld->Rdbfr[Buffer_Level++] = DECODER_SEQUENCE_END_CODE&0xff;
    }
  }
}
