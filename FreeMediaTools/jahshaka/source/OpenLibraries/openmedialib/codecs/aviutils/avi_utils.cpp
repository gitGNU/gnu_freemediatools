/*******************************************************************************
**
** The source file for the Jahshaka core avi file
...
//  HRESULT hr = AVIFileOpen(&pfile, fn, OF_WRITE|OF_CREATE, NULL);
  HRESULT hr = AVIFileOpenA(&pfile, fn, OF_WRITE|OF_CREATE, NULL);
...
//  { HANDLE hf=CreateFile(src,GENERIC_READ,FILE_SHARE_READ,NULL,OPEN_EXISTING,0,NULL);
  { HANDLE hf=CreateFileA(src,GENERIC_READ,FILE_SHARE_READ,NULL,OPEN_EXISTING,0,NULL);
