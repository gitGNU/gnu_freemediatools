...
PARTICLEDLL_API void partColor(float red, float green, float blue, float alpha = 1.0f);
...
PARTICLEDLL_API void partSize(float size_x, float size_y=1.0f, float size_z=1.0f);
...
PARTICLEDLL_API void pVertexBTracks(bool trackVertex = true);
...
PARTICLEDLL_API void pCopyGroup(int p_group_num, int index = 0, int copy_count = P_MAXINT);
...
PARTICLEDLL_API void pAvoid(bool avoid_inside, float look_ahead, float scale,
							 PDomainEnum dtype,
							 float a0=0.0f, float a1=0.0f, float a2=0.0f,
							 float a3=0.0f, float a4=0.0f, float a5=0.0f,
							 float a6=0.0f, float a7=0.0f, float a8=0.0f);
...
PARTICLEDLL_API void pFollow(float grav = 1.0f, float epsilon = P_EPS);

PARTICLEDLL_API void pGravitate(float grav = 1.0f, float epsilon = P_EPS);

PARTICLEDLL_API void pGravity(float dir_x, float dir_y, float dir_z);

PARTICLEDLL_API void pJet(float center_x, float center_y, float center_z, float grav = 1.0f,
						  float epsilon = P_EPS, float maxRadius = P_MAXFLOAT);

PARTICLEDLL_API void pKillOld(float ageLimit, bool kill_less_than = false);

PARTICLEDLL_API void pMatchVelocity(float grav = 1.0f, float epsilon = P_EPS);
...
PARTICLEDLL_API void pSource(float particleRate, PDomainEnum dtype,
							 float a0=0.0f, float a1=0.0f, float a2=0.0f,
							 float a3=0.0f, float a4=0.0f, float a5=0.0f,
							 float a6=0.0f, float a7=0.0f, float a8=0.0f);
